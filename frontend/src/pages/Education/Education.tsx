...
import { ItemsPerPageSelector } from './components/filters/ItemPerPageSelector'; // 复用Actions的组件
...
const Education: React.FC = () => {
  ...
  // Add the "itemsPerPage" parameter
  const { resources, stats, loading, totalPages, error, triggerSearch } = useEducationData(
    filters, 
    currentPage, 
    itemsPerPage
  );
