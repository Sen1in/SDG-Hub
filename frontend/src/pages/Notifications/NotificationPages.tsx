                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700 mb-2">
                        <span className="font-medium">{notification.data.inviter_username}</span> invited you to join the team{' '}
                        <span className="font-medium text-blue-600">"{notification.data.team_name}"</span>
                      </p>
